...
RENDER = True # was off for training so fast
if RENDER:
    ...
    pygame.init()
    screen_width, screen_height = 1536, 1024 # This resolution is for my laptop!
window_width, window_height = screen_width - 800, screen_height - 150

timer = pygame.time.Clock()
fps = 60

pygame.display.set_caption('Classic Donkey Kong: AI Edition (Simple)')
...
class DonkeyKongEnv:
    ...
    def get_state(self):
        ...
        return (mario_x, mario_y, int(can_climb), int(can_descend))
...
agent.load_policy("results/simple_map_policy.pkl")
player = Player(250, window_height - 130)
num_episodes = 10
...
# SAVE POLICY FOR USE IN COMPLEX GAME
# agent.save_policy("simple_map_policy.pkl")
